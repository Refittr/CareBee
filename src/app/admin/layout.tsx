...
import { LayoutDashboard, Users, Home, Activity, ArrowLeft, Shield, BarChart2, Mail, Send, MessageCircle } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/reddit", label: "Reddit", icon: MessageCircle, exact: false },
];
